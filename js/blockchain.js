...
function generateList(data) {
  ...
  $( '#json' ).append( data );
    ...
    $(this).find('span').hide();
		...
		var text = "";
		text += "<div class='col-xs-1'><span id='rank'>" + rank + "</span></div>";
		text += "<div class='col-xs-5'><span id='name'>" + name + " (" + symbol + ")</span></div>";
		text += "<div class='col-xs-2'><span id='price_eur'> " + price_eur + "</span></div>";
		text += "<div class='col-xs-4'><div class='row'>";
